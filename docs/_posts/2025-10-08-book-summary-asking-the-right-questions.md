...
- Chapter 2
		...
		- The habit we want to form is asking ourselves, "Why I am thinking what i am thinking?"
		- Potential speedbumps to crtiical thinking:
			- Stereotypes ->you approach any topic with certain beliefs or habits of mind
			- Halo effect -> tendency to recognize one +/- trait of person and then associate that to everything about the person.
			...
			- Asnwering the wrong question -> we unconsciously substitute our question for the one we were asked.
...
- Chapter 3
	- core idea: what is the issue and the conclusion?
		- issue -> question or controversy responsible for the conversation or discussion. It is the stimulus for what is being said.
			- prescriptive issue-> are those that raise questions about what we should do or what is right or wrong, good or bad?
			- descriptive issue -> those that raise questions about the accuracy of the descriptions about the past, present or future?
	 ...
	 - How to find the conclusion:
		 ...
		 - Look in likely locations (beginning or at the end)
		 - remember what a conclusion is not
			 - exmaples, facts, statistics definitions background information, evidence
		- check the context of communication and the authors background
- Chapter 4:
...
- Chapter 6
	...
	- clues fir identifying value assumptions:
		- investiagte the authores background
		- Ask, "why do the consequences of the authors positon seem so important to him or her?"
		- Search for similar social controversies to find analogous value assumptions
		- Use reverse role-playing. Take a position opposite to authors positoin and identify which values are important to that opposite position
		- Look for common value conflicts such as individual responsibilty vs collective responsibility
...
### Reference
Asking the right questions-A guide to critical thinking by M.Neil Browne, Stuart M keely.